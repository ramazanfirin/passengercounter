...
public class ScheduledVoyageResource {
    ...
    @PostMapping("/scheduled-voyages/getByRouteId")
    @Timed
    public ResponseEntity<List<ScheduledVoyage>> getByRouteId(@RequestBody SearchByRouteIdVM searchByRouteIdVM) {
    	...
    	List<ScheduledVoyage> stationRouteConnection = scheduledVoyageRepository.findByRouteId(searchByRouteIdVM.getRouteId(),startDate,endDate);
