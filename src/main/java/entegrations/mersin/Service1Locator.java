...
public class Service1Locator extends org.apache.axis.client.Service implements entegrations.mersin.Service1 {
    ...
    private java.lang.String Service1Soap_address = "http://85.111.6.243:8081/Service1.asmx";
    ...
    public entegrations.mersin.Service1Soap getService1Soap() throws javax.xml.rpc.ServiceException {
    ...
    public entegrations.mersin.Service1Soap getService1Soap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            entegrations.mersin.Service1SoapStub _stub = new entegrations.mersin.Service1SoapStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (entegrations.mersin.Service1Soap.class.isAssignableFrom(serviceEndpointInterface)) {
                entegrations.mersin.Service1SoapStub _stub = new entegrations.mersin.Service1SoapStub(new java.net.URL(Service1Soap_address), this);
                _stub.setPortName(getService1SoapWSDDServiceName());
                return _stub;
            }
        }
