...
public class BusDensityHistoryResourceIntTest {
    ...
    public void setup() {
        ...
        final BusDensityHistoryResource busDensityHistoryResource = new BusDensityHistoryResource(busDensityHistoryRepository, stationRepository, densityCalculaterService,integrationService);
